(function () {
    angular
        .module('/resourceManage.html', [])
        .run([
            '$templateCache',
            function ($templateCache) {
                $templateCache.put('/resourceManage.html',
                    ...
                    "         <div ng-if=\"col.filed=='resId'\" style='display: none;'></div>" +
                    "       </td>\n" +
                    "     </tr>\n" +
                    "   </tbody>\n" +
                    " </table>\n" +
    ...
    angular
            ...
            function ($timeout,
                ...
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        attrs.expandLevel = attrs.expandLevel ? attrs.expandLevel : '2';
        ...
        .provider('treegridTemplate', function () {
            var templatePath = '/resourceManage.html';
