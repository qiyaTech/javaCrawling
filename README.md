...
* 1.注册一个“无忧代理“账号，这里使用代理服务是收费的哦～

* 2.注册账号后需要创建一个订单，然后保存订单号。

* 3.在项目的配置文件[application-dev.properties](https://github.com/qiyaTech/javaCrawling/blob/dev_github_20170807_deng/boss/src/main/resources/application-dev.properties)中添加配置：
  ```poxy.data5u.order = 无忧代理订单号```
